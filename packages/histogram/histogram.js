...
const convertGeometry = require('../convert-geometry/convert-geometry');
const intersectPolygon = require('../intersect-polygon/intersect-polygon');
 ...
 */
function getHistogramsForRaster(georaster, geom, options) {
...
module.exports = getHistogramsForRaster;
